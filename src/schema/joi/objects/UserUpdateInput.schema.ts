...
import { BookingUpdateManyWithoutUserNestedInputSchemaObject } from './BookingUpdateManyWithoutUserNestedInput.schema'
...
Joi.object().keys(StringFieldUpdateOperationsInputSchemaObject)),
  ...
  booking: Joi.object().keys(BookingUpdateManyWithoutUserNestedInputSchemaObject)
}