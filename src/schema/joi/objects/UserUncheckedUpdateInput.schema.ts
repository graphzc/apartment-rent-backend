...
import { BookingUncheckedUpdateManyWithoutUserNestedInputSchemaObject } from './BookingUncheckedUpdateManyWithoutUserNestedInput.schema'
...
Joi.object().keys(StringFieldUpdateOperationsInputSchemaObject)),
  ...
  booking: Joi.object().keys(BookingUncheckedUpdateManyWithoutUserNestedInputSchemaObject)
}