...
exports.IntFilterSchemaObject = {
    ...
    not: joi_1.default.alternatives().try(joi_1.default.number(), joi_1.default.object().keys(NestedIntFilter_schema_1.NestedIntFilterSchemaObject))
};
