...
exports.PaymentScalarWhereInputSchemaObject = void 0;
// @ts-nocheck
...
exports.PaymentScalarWhereInputSchemaObject = {
    AND: joi_1.default.alternatives().try(joi_1.default.link('#PaymentScalarWhereInput'), joi_1.default.array().items(joi_1.default.link('#PaymentScalarWhereInput'))),
    OR: joi_1.default.array().items(joi_1.default.link('#PaymentScalarWhereInput')),
    NOT: joi_1.default.alternatives().try(joi_1.default.link('#PaymentScalarWhereInput'), joi_1.default.array().items(joi_1.default.link('#PaymentScalarWhereInput'))),
