...
exports.RoomUpdateWithoutBookingInputSchemaObject = void 0;
// @ts-nocheck
const joi_1 = __importDefault(require("joi"));
const IntFieldUpdateOperationsInput_schema_1 = require("./IntFieldUpdateOperationsInput.schema");
const DateTimeFieldUpdateOperationsInput_schema_1 = require("./DateTimeFieldUpdateOperationsInput.schema");
const ApartmentUpdateOneRequiredWithoutRoomNestedInput_schema_1 = require("./ApartmentUpdateOneRequiredWithoutRoomNestedInput.schema");
exports.RoomUpdateWithoutBookingInputSchemaObject = {
    ...
    apartment: joi_1.default.object().keys(ApartmentUpdateOneRequiredWithoutRoomNestedInput_schema_1.ApartmentUpdateOneRequiredWithoutRoomNestedInputSchemaObject)
};
