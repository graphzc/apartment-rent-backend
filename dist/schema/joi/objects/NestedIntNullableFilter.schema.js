...
exports.NestedIntNullableFilterSchemaObject = void 0;
// @ts-nocheck
const joi_1 = __importDefault(require("joi"));
exports.NestedIntNullableFilterSchemaObject = {
    equals: joi_1.default.alternatives().try(joi_1.default.number()),
    ...
    not: joi_1.default.alternatives().try(joi_1.default.number(), joi_1.default.link('#NestedIntNullableFilter'))
};
