...
exports.DateTimeWithAggregatesFilterSchemaObject = void 0;
// @ts-nocheck
...
exports.DateTimeWithAggregatesFilterSchemaObject = {
    equals: joi_1.default.date(),
    lt: joi_1.default.date(),
    lte: joi_1.default.date(),
    gt: joi_1.default.date(),
    gte: joi_1.default.date(),
    not: joi_1.default.alternatives().try(joi_1.default.object().keys(NestedDateTimeWithAggregatesFilter_schema_1.NestedDateTimeWithAggregatesFilterSchemaObject)),
