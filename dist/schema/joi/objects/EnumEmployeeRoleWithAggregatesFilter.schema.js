...
exports.EnumEmployeeRoleWithAggregatesFilterSchemaObject = void 0;
// @ts-nocheck
const joi_1 = __importDefault(require("joi"));
const NestedEnumEmployeeRoleWithAggregatesFilter_schema_1 = require("./NestedEnumEmployeeRoleWithAggregatesFilter.schema");
...
exports.EnumEmployeeRoleWithAggregatesFilterSchemaObject = {
    not: joi_1.default.alternatives().try(joi_1.default.object().keys(NestedEnumEmployeeRoleWithAggregatesFilter_schema_1.NestedEnumEmployeeRoleWithAggregatesFilterSchemaObject)),
