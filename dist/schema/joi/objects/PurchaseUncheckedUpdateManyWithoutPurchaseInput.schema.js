...
exports.PurchaseUncheckedUpdateManyWithoutPurchaseInputSchemaObject = void 0;
// @ts-nocheck
...
exports.PurchaseUncheckedUpdateManyWithoutPurchaseInputSchemaObject = {
    ...
    customerOrderId: joi_1.default.alternatives().try(joi_1.default.string(), joi_1.default.object().keys(StringFieldUpdateOperationsInput_schema_1.StringFieldUpdateOperationsInputSchemaObject)),
