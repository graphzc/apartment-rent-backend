...
exports.StringNullableFilterSchemaObject = void 0;
// @ts-nocheck
...
exports.StringNullableFilterSchemaObject = {
    ...
    not: joi_1.default.alternatives().try(joi_1.default.string(), joi_1.default.object().keys(NestedStringNullableFilter_schema_1.NestedStringNullableFilterSchemaObject))
};
