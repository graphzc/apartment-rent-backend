...
exports.NestedStringFilterSchemaObject = void 0;
// @ts-nocheck
const joi_1 = __importDefault(require("joi"));
exports.NestedStringFilterSchemaObject = {
    ...
    not: joi_1.default.alternatives().try(joi_1.default.string(), joi_1.default.link('#NestedStringFilter'))
};
