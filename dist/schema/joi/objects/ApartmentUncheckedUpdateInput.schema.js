...
exports.ApartmentUncheckedUpdateInputSchemaObject = void 0;
// @ts-nocheck
const joi_1 = __importDefault(require("joi"));
const IntFieldUpdateOperationsInput_schema_1 = require("./IntFieldUpdateOperationsInput.schema");
const StringFieldUpdateOperationsInput_schema_1 = require("./StringFieldUpdateOperationsInput.schema");
const DateTimeFieldUpdateOperationsInput_schema_1 = require("./DateTimeFieldUpdateOperationsInput.schema");
const RoomUncheckedUpdateManyWithoutApartmentNestedInput_schema_1 = require("./RoomUncheckedUpdateManyWithoutApartmentNestedInput.schema");
exports.ApartmentUncheckedUpdateInputSchemaObject = {
    ...
    room: joi_1.default.object().keys(RoomUncheckedUpdateManyWithoutApartmentNestedInput_schema_1.RoomUncheckedUpdateManyWithoutApartmentNestedInputSchemaObject)
};
